...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///backend_test'),
}
...
MIGRATION_MODULES = {
    'sites': 'backend_test.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Luis Alfaro""", 'luipi.alfaro@gmail.com'),
]
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ['backend_test.taskapp.celery.CeleryAppConfig']
if USE_TZ:
